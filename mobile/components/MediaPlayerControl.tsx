                    ...
                    <View style={{
                        ...
                        {isMuted ?  
                            <PlayerBtn 
                                ...
                                onPress={handleMute} 
                                svgPaths={["M15.4 16L14 14.6l2.6-2.6L14 9.4L15.4 8l2.6 2.6L20.6 8L22 9.4L19.4 12l2.6 2.6l-1.4 1.4l-2.6-2.6l-2.6 2.6ZM3 15V9h4l5-5v16l-5-5H3Z"]}
                                size={25}
                            />
                            :
                            <PlayerBtn 
                                style={{  marginRight: 10, marginLeft: 10  }} 
                                onPress={handleMute} 
                                svgPaths={["M14 20.725v-2.05q2.25-.65 3.625-2.5t1.375-4.2q0-2.35-1.375-4.2T14 5.275v-2.05q3.1.7 5.05 3.138T21 11.975q0 3.175-1.95 5.613T14 20.725ZM3 15V9h4l5-5v16l-5-5H3Zm11 1V7.95q1.175.55 1.838 1.65T16.5 12q0 1.275-.663 2.363T14 16Z"]}
                                size={25}
                            />
                        }
                        
                        {/* Loop */}
                        {loopState === LoopState.NoLoop || loopState === LoopState.Loop1 ?
                        ...
                        {isFullScreen ?
                            <PlayerBtn 
                                ...
                                svgPaths={["M204 181.372L38.628 16H16v22.628L181.372 204H44v32h192V44h-32v137.372zM326.628 304H464v-32H272v192h32V326.628L473.372 496H496v-22.628L326.628 304z"]}
                                fill='red'
                                viewBox="0 0 512 512"
                                size={25}
                            />
                            ...
                            <PlayerBtn 
                                style={{  marginRight: 10, marginLeft: 10  }}
                                onPress={handleFullScreen} 
                                svgPaths={["M208 48V16H16v192h32V70.627l160.687 160.686l22.626-22.626L70.627 48H208zm256 256v137.373L299.313 276.687l-22.626 22.626L441.373 464H304v32h192V304h-32z"]}
                                viewBox="0 0 512 512"
                                size={25}
                            />
                        }
